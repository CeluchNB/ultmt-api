...
export const INVALID_USERNAME = 'This username is invalid'
...
export const CLAIM_GUEST_REQUEST_ALREADY_EXISTS = 'This user has already requested to claim this guest.'
